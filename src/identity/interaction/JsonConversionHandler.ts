...
import type { Json, JsonInteractionHandler, JsonInteractionHandlerInput } from './JsonInteractionHandler';

// TODO: does not check handler.canHandle so will take anything that can be JSON
