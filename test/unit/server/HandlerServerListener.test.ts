...
import { HandlerServerListener } from '../../../src/server/HandlerServerListener';
...
describe('A HandlerServerListener', (): void => {
  ...
  let listener: HandlerServerListener;
  ...
  beforeEach(async(): Promise<void> => {
    ...
    listener = new HandlerServerListener(handler);
  ...
  it('prints the stack trace if that option is enabled.', async(): Promise<void> => {
    ...
    listener = new HandlerServerListener(handler, true);
    await listener.handle(server);
